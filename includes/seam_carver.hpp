...
public:
  ...
  // helper function
  int Innercase(int row, int col) const; 
  int Lefttop(int row, int col) const;
  int Leftbot(int row, int col) const;
  int Righttop(int row, int col) const;
  int Rightbot(int row, int col) const;
  int LeftChunk(int row, int col) const;
  int RightChunk(int row, int col) const;
  int TopChunk(int row, int col) const;
  int BotChunk(int row, int col) const;
